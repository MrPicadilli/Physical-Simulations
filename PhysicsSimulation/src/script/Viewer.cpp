...
int Viewer::render()
{
    ...
    gl.model(Translation(1, 0, 0) * Scale(5, 5, 5));
    //std::cout << length(Vector(1, 0, 0) - Vector(5,5,5)) << "cercle" << std::endl ;
    gl.draw(m_sphere);
    

    //draw_sphere(Translation(0, 0, 0) * Scale(2, 2, 2));

    // draw_sphere(Point(0,-10,0,0.1));
